...
%% This function computes the cycle arithmetic mean (see [1] for details).
...
function cycle_AM = cycle_arithmetic_mean(ArcsInCycle, M)
...
for i = 1:size(ArcsInCycle,2)
    ...
    cycle_AM = cycle_AM + M.Edges{arc_idx,2};
end

cycle_AM = cycle_AM*(1/length);
